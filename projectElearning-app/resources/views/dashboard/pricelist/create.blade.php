    ...
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <div class="input-group">
          <input type="text" class="form-control" id="validationCustomUsername" id="duration" name="duration" value="{{ old('duration') }}" placeholder="" aria-describedby="inputGroupPrepend" required>
